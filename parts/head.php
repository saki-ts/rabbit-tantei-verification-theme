...
<html lang="ja">
  <head>
    ...
    <?php if(is_page( array('recruits', 'recruit2', 'recruit3', 'recruit', 'recruit-confirm', 'recruit-thanks') )):?>
    <link rel="stylesheet" href="<?php echo $themePath; ?>css/style_recruit.css">
    <?php endif; ?>
